...
import { BellIcon, Clock1Icon, ClockIcon, MessageSquareIcon, UserCheckIcon } from 'lucide-react'
                ...
                <div className='flex items-center justify-between '>
                  <div className='flex items-center gap-3'>
                    <div className='avatar'>
                      <div className='w-14 h-14 rounded-full bg-base-300 overflow-hidden'>
                  ...
                  <div className='card-body p-4'>
                    <div className='flex items-start gap-3'>
                      ...
                      <div className='flex-1 '>
                        ...
                        <p className='text-xs flex items-center opacity-70'><ClockIcon/> Recently</p>
                      </div>
                      <div className='badge badge-success'><MessageSquareIcon className='h-3 w-3 mr-1'/> New Friend</div>
                    </div>
                  </div>
                </div>
              ))}
